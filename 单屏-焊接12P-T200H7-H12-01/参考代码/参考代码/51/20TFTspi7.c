/********************金逸晨**************************
******************2.0寸    7PIN SPI OLED FOR AT89S52/STC12*************
*****AT89S52驱动**************************
***** P20----3  SCK   ,  P21----4  SDA   ,  P22----5   RES
	  P23-----6   DC   , P24-----7  CS   ,  P25----8   FOS     P26----9  CS2
***** BY:GU 
*********ST7789V2
...
#define SPI_CS_0  P2&=clr_4          //P2_4
#define SPI_CS_1  P2|=set_4
...
code unsigned char china_char[][32]=       //
{
